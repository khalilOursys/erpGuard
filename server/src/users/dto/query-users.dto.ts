...
export class QueryUsersDto {
  ...
  @IsOptional()
  @IsString()
  @IsIn(['displayname', 'identifier', 'email', 'createdAt', 'updatedAt', 'role'])
  ...
  // filter by permission name (optional). Returns only users who have this permission (via userPermissions)
  @IsOptional()
  @IsString()
  permission?: string;
}
