...
-- CreateTable
CREATE TABLE "public"."_CityToSite" (
    "A" INTEGER NOT NULL,
    "B" INTEGER NOT NULL,

    CONSTRAINT "_CityToSite_AB_pkey" PRIMARY KEY ("A","B")
);
...
-- AddForeignKey
ALTER TABLE "public"."ClientContact" ADD CONSTRAINT "ClientContact_fileId_fkey" FOREIGN KEY ("fileId") REFERENCES "public"."File"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."_CityToSite" ADD CONSTRAINT "_CityToSite_A_fkey" FOREIGN KEY ("A") REFERENCES "public"."City"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."_CityToSite" ADD CONSTRAINT "_CityToSite_B_fkey" FOREIGN KEY ("B") REFERENCES "public"."Site"("id") ON DELETE CASCADE ON UPDATE CASCADE;
