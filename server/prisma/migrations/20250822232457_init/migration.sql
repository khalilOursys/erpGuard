...
-- CreateEnum
CREATE TYPE "public"."GuardType" AS ENUM ('PERMANENT', 'CONTRACTOR');
...
-- CreateEnum
CREATE TYPE "public"."BillingLineType" AS ENUM ('CHIEF_GUARD', 'GUARD', 'CUSTOM');
...
CREATE TABLE "public"."Guard" (
    ...
    "email" TEXT NOT NULL,
    "phone" TEXT,
    "type" "public"."GuardType" NOT NULL,
...
-- CreateTable
CREATE TABLE "public"."GuardContract" (
    "id" SERIAL NOT NULL,
    ...
    CONSTRAINT "GuardContract_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "public"."ClientContract" (
    ...
    "clientPrice" DECIMAL(16,2) NOT NULL,
    "currency" TEXT,
    "companyId" INTEGER NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "public"."Mission" (
    ...
    "extraGuardSlots" INTEGER NOT NULL DEFAULT 0,
    "chiefGuardId" INTEGER,
...
-- CreateTable
CREATE TABLE "public"."MissionRequirement" (
    "id" SERIAL NOT NULL,
...
-- CreateTable
CREATE TABLE "public"."GuardQualification" (
    "id" SERIAL NOT NULL,
    "code" TEXT NOT NULL,
    "name" TEXT NOT NULL,
    "description" TEXT,
...
-- CreateTable
CREATE TABLE "public"."GuardQualificationRel" (
    "id" SERIAL NOT NULL,
    "guardId" INTEGER NOT NULL,
    "qualificationId" INTEGER NOT NULL,
    ...
    CONSTRAINT "GuardQualificationRel_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "Guard_email_key" ON "public"."Guard"("email");

-- CreateIndex
CREATE INDEX "Guard_companyId_idx" ON "public"."Guard"("companyId");

-- CreateIndex
CREATE INDEX "Guard_email_idx" ON "public"."Guard"("email");

-- CreateIndex
CREATE UNIQUE INDEX "GuardContract_contractNumber_key" ON "public"."GuardContract"("contractNumber");

-- CreateIndex
CREATE INDEX "GuardContract_guardId_idx" ON "public"."GuardContract"("guardId");

-- CreateIndex
CREATE INDEX "GuardContract_startDate_endDate_idx" ON "public"."GuardContract"("startDate", "endDate");
...
-- CreateIndex
CREATE INDEX "MissionRequirement_missionId_idx" ON "public"."MissionRequirement"("missionId");

-- CreateIndex
CREATE INDEX "MissionRequirement_qualificationId_idx" ON "public"."MissionRequirement"("qualificationId");

-- CreateIndex
CREATE INDEX "MissionAssignment_missionId_idx" ON "public"."MissionAssignment"("missionId");

-- CreateIndex
CREATE INDEX "MissionAssignment_guardId_idx" ON "public"."MissionAssignment"("guardId");
...
-- CreateIndex
CREATE UNIQUE INDEX "GuardQualification_code_key" ON "public"."GuardQualification"("code");

-- CreateIndex
CREATE INDEX "GuardQualification_code_idx" ON "public"."GuardQualification"("code");

-- CreateIndex
CREATE INDEX "GuardQualificationRel_guardId_idx" ON "public"."GuardQualificationRel"("guardId");

-- CreateIndex
CREATE INDEX "GuardQualificationRel_qualificationId_idx" ON "public"."GuardQualificationRel"("qualificationId");

-- CreateIndex
CREATE INDEX "PaymentRecord_guardId_idx" ON "public"."PaymentRecord"("guardId");
...
-- CreateIndex
CREATE INDEX "BillingLine_guardId_idx" ON "public"."BillingLine"("guardId");
...
-- AddForeignKey
ALTER TABLE "public"."Guard" ADD CONSTRAINT "Guard_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES "public"."Company"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."GuardContract" ADD CONSTRAINT "GuardContract_guardId_fkey" FOREIGN KEY ("guardId") REFERENCES "public"."Guard"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."GuardContract" ADD CONSTRAINT "GuardContract_fileId_fkey" FOREIGN KEY ("fileId") REFERENCES "public"."File"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."Mission" ADD CONSTRAINT "Mission_chiefGuardId_fkey" FOREIGN KEY ("chiefGuardId") REFERENCES "public"."Guard"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."MissionRequirement" ADD CONSTRAINT "MissionRequirement_missionId_fkey" FOREIGN KEY ("missionId") REFERENCES "public"."Mission"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."MissionRequirement" ADD CONSTRAINT "MissionRequirement_qualificationId_fkey" FOREIGN KEY ("qualificationId") REFERENCES "public"."GuardQualification"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."MissionAssignment" ADD CONSTRAINT "MissionAssignment_guardId_fkey" FOREIGN KEY ("guardId") REFERENCES "public"."Guard"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."Attendance" ADD CONSTRAINT "Attendance_guardId_fkey" FOREIGN KEY ("guardId") REFERENCES "public"."Guard"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."GuardQualification" ADD CONSTRAINT "GuardQualification_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES "public"."Company"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."GuardQualificationRel" ADD CONSTRAINT "GuardQualificationRel_guardId_fkey" FOREIGN KEY ("guardId") REFERENCES "public"."Guard"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."GuardQualificationRel" ADD CONSTRAINT "GuardQualificationRel_qualificationId_fkey" FOREIGN KEY ("qualificationId") REFERENCES "public"."GuardQualification"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."PaymentRecord" ADD CONSTRAINT "PaymentRecord_guardId_fkey" FOREIGN KEY ("guardId") REFERENCES "public"."Guard"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."BillingLine" ADD CONSTRAINT "BillingLine_guardId_fkey" FOREIGN KEY ("guardId") REFERENCES "public"."Guard"("id") ON DELETE SET NULL ON UPDATE CASCADE;
